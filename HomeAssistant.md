...
Whenever you want the clock to return to the normal clock face manually, Home Assistant can publish an empty payload to the `digiframe/<your-clock-id>/stop/set` topic or trigger the `button.digiframe_back_to_clock` entity.
